...
export const SKILLS_DATA = [
  // Frontend Skills
  {
    ...
    proficiency: 85,
    icon: '/img/icons/svg/typescript-icon.svg',
  ...
  },
  {
    ...
    category: 'frontend' as const,
    proficiency: 90,
    icon: '/img/icons/svg/javascript.svg',
    iconType: 'image' as const,
    color: '#F7DF1E',
  ...
  },
  {
    ...
    category: 'frontend' as const,
    proficiency: 95,
    icon: '/img/icons/svg/html-5-svgrepo-com.svg',
    iconType: 'image' as const,
    color: '#E34F26',
  ...
  },
  {
    ...
    category: 'frontend' as const,
    proficiency: 90,
    icon: '/img/icons/svg/css-3-svgrepo-com.svg',
    iconType: 'image' as const,
    color: '#1572B6',
  ...
  },
  {
    ...
    category: 'frontend' as const,
    proficiency: 85,
    icon: '/img/icons/svg/sass-svgrepo-com.svg',
    iconType: 'image' as const,
    color: '#CC6699',
  ...
  // Backend Skills
  {
    ...
    proficiency: 85,
    icon: '/img/icons/svg/node-js-green-svgrepo-com.svg',
    iconType: 'image' as const,
    color: '#339933',
  ...
  },
  {
    ...
    category: 'backend' as const,
    proficiency: 70,
    icon: '/img/icons/svg/python-svgrepo-com.svg',
    iconType: 'image' as const,
    color: '#3776AB',
  ...
  },
  {
    ...
    category: 'backend' as const,
    proficiency: 80,
    icon: '/img/icons/svg/postgresql-svgrepo-com.svg',
    iconType: 'image' as const,
    color: '#336791',
  ...
  },
  {
    ...
    category: 'backend' as const,
    proficiency: 70,
    icon: '/img/icons/svg/oauth-svgrepo-com.svg',
    iconType: 'image' as const,
    color: '#EB5424',
  ...
  // Libraries
  {
    ...
    proficiency: 85,
    icon: '/img/icons/svg/redux-logo-svgrepo-com.svg',
    iconType: 'image' as const,
    color: '#764ABC',
  ...
  },
  {
    ...
    category: 'libraries' as const,
    proficiency: 85,
    icon: '/img/icons/svg/axios-logo.svg',
    iconType: 'image' as const,
    color: '#5A29E4',
  ...
  },
  {
    ...
    category: 'libraries' as const,
    proficiency: 70,
    icon: '/img/icons/tailwind-css-logo.png',
    iconType: 'image' as const,
    color: '#06B6D4',
  ...
  },
  {
    ...
    category: 'tools' as const,
    proficiency: 95,
    icon: '/img/icons/Visual_Studio_Code_icon.png',
    iconType: 'image' as const,
    color: '#007ACC',
  ...
  },
  {
    ...
    category: 'design' as const,
    proficiency: 80,
    icon: '/img/icons/svg/adobe-illustrator-svgrepo-com.svg',
    iconType: 'image' as const,
    color: '#FF9A00',
  ...
  },
  {
    ...
    category: 'design' as const,
    proficiency: 90,
    icon: '/img/icons/affinity-designer-2-logo.png',
    iconType: 'image' as const,
    color: '#1B72BE',
    description: 'Image editing software',
    yearsExperience: 2,
